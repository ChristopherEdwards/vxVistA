PXRMEXLB ;SLC/PJH - Reminder Dialog Exchange. ;05/16/2007
...
DBUILD(IND,NITEMS,FILENUM) ;
 N DARRAY,DDATA,DDLG,DEND,DLOC,DMAP,DNAM,DNODE,DSEQ,DSTRT,DSUB,FILE,JND
 N REPCNT,RESGRP,TEMPRESL,CNT
 ;
 ...
 ...S REPCNT=REPCNT+1,^TMP("PXRMEXTMP",$J,"DREPL",REPCNT,DDLG)=DNAM_U_DLOC
 ..I $E(DNODE,1,4)'=".01~" Q
 ...
 ...S ^TMP("PXRMEXTMP",$J,"DMAP",DDLG,CNT+1)=DNAM_U_DLOC
 ...
 ..;S ^TMP("PXRMEXTMP",$J,"RESULT",DDLG,TEMPRESL(DDLG))=""
...
DPARSE N DCNT,DFIND,DFIAD,DFNAM,DFQUIT,DLCT,DLINES,DSUB,DTEXT,DTXT,DTYP
 ...
 N DARRAY,DDATA,DFNUM,DRAW,DSTRING,RESNAM
 ...
 .S DTEXT=$P($G(^PXD(811.8,IEN,100,DSUB,0)),";",3) Q:DTEXT=""
 .S DTXT=$P(DTEXT,"~",2)
 .S RESGRP(DNAM)=DSTRT_U_DEND_U_IND_U_JND
 ;
 I DTYP="prompt" D
