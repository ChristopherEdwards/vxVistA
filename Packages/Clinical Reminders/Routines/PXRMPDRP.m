PXRMPDRP ;SLC/AGP,PKR - Patient List Demographic report print routine ;11/16/2007
...
APPPRINT(DFN,DDATA,SUB) ;Print appointment data.
 ...
 D ADDTXT(HDR)
 S COUNT=0
 F  S COUNT=$O(^TMP("PXRMPLD",$J,DFN,"APP",COUNT)) Q:COUNT=""  D
 . S TEMP=$G(^TMP("PXRMPLD",$J,DFN,"APP",COUNT))
 . S LINE=""
...
DELIMPR(DC,PLIEN,DDATA) ;
 ...
 .. W !,PNAME_DC
 .. F IND=1:1:NDT D
 ... I DATALIST(IND)="ADD" D PDELDATA(DFN,DC,DATALIST(IND),.DDATA,"ADD") Q
 ... I DATALIST(IND)="APP" D PAPPDATA(DFN,DC,.DDATA,"APP") Q
 ... I DATALIST(IND)="DEM" D PDELDATA(DFN,DC,DATALIST(IND),.DDATA,"DEM") Q
 ... I DATALIST(IND)="ELIG" D PDELDATA(DFN,DC,DATALIST(IND),.DDATA,"ELIG") Q
 ... I DATALIST(IND)="FIND" D PFINDATA(DFN,DC,.DDATA,"FIND") Q
 ... I DATALIST(IND)="INP" D PDELDATA(DFN,DC,DATALIST(IND),.DDATA,"INP") Q
...
PAPPDATA(DFN,DC,DDATA,SUB) ;Print the delimited appointment data.
 ...
 Q
 ;
PDELDATA(DFN,DC,DTYPE,DDATA,SUB) ;Print the delimited data.
 N IND,JND,KND,LINE,LND,TEMP,TTEMP
 S TEMP=$G(^TMP("PXRMPLD",$J,DFN,DTYPE))
 S LINE=""
 F IND=1:1:DDATA(DTYPE,"LEN") D
 . S JND=$P(DDATA(DTYPE),",",IND)
 . S KND=""
 . F  S KND=$O(DDATA(DTYPE,JND,KND)) Q:KND=""  D
 .. S MAX=$P(DDATA(DTYPE,JND,KND),U,3)
