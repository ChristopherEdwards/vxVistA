VFDVFOIZ ;DSS/SGM - INITIALIZE A CACHE.DAT CLONE;02 Dec 2009 11:31
...
MSP ; mailman site parameters
 ...
 I $G(TMP(.01,"I"))=X D MSG("MAILMAN SITE PARAMETERS file",1) Q
 ...
 I Z'="" D ERR("MAILMAN SITE PARAMETERS file indexes needed fixing:")
 I Z'="" F I="NAME","NETNAME","NUM","PARENT" I Z[(I_U) D
...
RPC ; rpc broker site parameters
 ...
 N I,J,X,Y,Z,TMP,VFDAT
 W !!,LINE F I=1:1:3 W !,$TR($T(RPC+I),";"," ")
 D DIQS(.VFDAT,8994.1,1) M TMP=VFDAT(8994.1,"1,") K VFDAT
 S VFDAT(.01)=DATA("NEW",4.2,"SUB"),Y=$G(TMP(.01,"I"))
 I Y="" S Z=$$UPDATE(8994.1,,.VFDAT)
 I Y'="",Y'=VFDAT(.01) S Z=$$DIE(8994.1,1,.VFDAT)
...
ZTCLEAN(VDAT) ;
 ...
 F X="C","DEVTRY","DLG","ER","IDLE","MON","STATUS","SUB","UPDATE" K ^%ZTSCH(X)
