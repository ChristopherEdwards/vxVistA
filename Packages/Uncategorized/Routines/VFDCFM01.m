VFDCFM01 ;DSS/SGM - COMMON FILEMAN UTILITIES ;01/14/2005 13:26
...
M N I,X,Y,Z,VFDOUT,VFLG
 ...
 D MSG^DIALOG(FLGS,.VFDOUT,WIDTH,LEFT,$G(INPUT))
 K OUT I 'VFLG M OUT=VFDOUT Q
 S OUT="" F I=0:0 S I=$O(VFDOUT(I)) Q:'I  D  I VFLG,$L(OUT)>507 Q
 .S X=$L(OUT),Y=$L(VFDOUT(I))
 .I (X+Y)<508 S OUT=OUT_VFDOUT(I)_" "
 .E  S OUT=OUT_$E(VFDOUT(I),1,508-X)
 .Q
