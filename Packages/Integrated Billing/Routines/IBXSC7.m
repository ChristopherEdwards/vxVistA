IBXSC7 ; GENERATED FROM 'IB SCREEN7' INPUT TEMPLATE(#513), FILE 399;07/22/08
 D DE G BEGIN
...
C21F1 Q
X21 Q
22 D:$D(DG)>9 F^DIE17,DE S DQ=22,DW="U3;2",DV="*P8932.1'",DU="",DLB="DEFAULT DIVISION TAXONOMY",DIFLD=243
 S DU="USC(8932.1,"
 G RE
X22 S DIC("S")="I $P($G(^(90002)),U,2)=""N""" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
23 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=23 D X23 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X23 D DISPTAX^IBCEP81($P($G(^DGCR(399,DA,"U3")),U,2),"Default Division")
 Q
