IBXSC4 ; GENERATED FROM 'IB SCREEN4' INPUT TEMPLATE(#510), FILE 399;02/03/08
 D DE G BEGIN
...
X29 I $P(^DGCR(399,DA,0),U,19)=2 S Y="@49"
 Q
30 S D=0 K DE(1) ;47
 S DIFLD=47,DGO="^IBXSC44",DC="2^399.047PA^CV^",DV="399.047M*P399.1'X",DW="0;1",DOW="VALUE CODE",DLB="Select "_DOW S:D DC=DC_D
 S DU="DGCR(399.1,"
