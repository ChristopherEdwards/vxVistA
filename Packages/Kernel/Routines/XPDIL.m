XPDIL ;SFISC/RSD - load Distribution Global ; 1/6/09 8:25am
...
ST ;global input
 ...
 ;DSS/LM - Begin Mods - Replaced 75 with 175 (maximum length for HFS file specification when loading)
 S DIR(0)="F^3:175",DIR("A")="Enter a Host File",DIR("?")="Enter a filename and/or path to input Distribution."
 ;DSS/LM - End mods
 ;p345-rename AND* to XPD*
 I '$G(XPDAUTO) D ^DIR I $D(DIRUT) S XPDQUIT=1 Q
