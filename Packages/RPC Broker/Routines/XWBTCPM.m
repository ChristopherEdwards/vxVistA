XWBTCPM ;ISF/RWF - BROKER TCP/IP PROCESS HANDLER ;01/04/2006  62562.56228
 ;;1.1;RPC BROKER;**35,43**;Mar 28, 1997;Build 7
...
CONNTYPE ;
 ...
 N VFDAUDIT,VFDCNT,VFDDFN,VFDIENS,VFDHNDL,VFDPMODE,VFDQUIT,VFDRPC,VFDUMODE
...
INIT ;Setup
 ...
 S VFDAUDIT=$$GET^XPAR("SYS","VFD RPC AUDIT ENABLED")
 S VFDPMODE=$$GET^XPAR("SYS","VFD RPC AUDIT PATIENTS")
 S VFDUMODE=$$GET^XPAR("SYS","VFD RPC AUDIT USERS")
 S (VFDCNT,VFDDFN,VFDIENS,VFDQUIT,VFDRPC)="",VFDHNDL=$$NOW^XLFDT_"~"_$J D
