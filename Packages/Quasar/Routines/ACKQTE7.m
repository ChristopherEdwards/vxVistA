...
35 D:$D(DG)>9 F^DIE17,DE S DQ=35,D=0 K DE(1) ;2.7
 S DIFLD=2.7,DGO="^ACKQTE8",DC="1^509850.66PA^2.7^",DV="509850.66M*P509850.3'X",DW="0;1",DOW="SECONDARY PROVIDER",DLB="Select "_DOW S:D DC=DC_D
 S DU="ACK(509850.3,"
