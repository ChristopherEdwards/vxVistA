...
GETFLDS(DA) ; Define GMPFLD(#) and GMPORIG(#) Arrays with Current Values
 ...
 S DR=".01;.03;.05;.08:1.02;1.05:1.18;21600.01" D EN^DIQ1
 F I=.01,.03,.05,.08,.12,.13,1.01,1.02,1.05,1.06,1.07,1.08,1.09,1.1,1.11,1.12,1.13,1.14,1.15,1.16,1.17,1.18,21600.01 D
 . S GMPORIG(I)=$G(GMPL(9000011,DA,I,"I")),EXT=""
 . I I=1.01,GMPL(9000011,DA,I,"I")'>1 S GMPORIG(I)="" Q
 . Q:(GMPORIG(I)="")!(I=1.02)
 . I "^.01^.05^.12^1.01^1.05^1.06^1.08^1.1^1.14^21600.01^"[(U_I_U) S EXT=GMPL(9000011,DA,I,"E")
